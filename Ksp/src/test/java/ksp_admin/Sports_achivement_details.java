...
public class Sports_achivement_details extends Utilies {
	...
	@FindBy(id = "SportsAcheivement_Code")
	WebElement codeField;

	@FindBy(id = "SportsAcheivement_Title")
	WebElement titleField;

	@FindBy(id = "SportsAcheivement_OrderIndex")
	WebElement orderIndexDropdown;

	@FindBy(id = "SportsAcheivement_StatusCode")
	...
	@FindBy(id = "SportsAcheivementDTO_Code")
	WebElement Editcode;

	@FindBy(id = "SportsAcheivementDTO_Title")
	WebElement Edittitle;

	@FindBy(id = "SportsAcheivementDTO_OrderIndex")
	WebElement Editorderindex;

	@FindBy(id = "SportsAcheivementDTO_StatusCode")
	...
	public Sports_achivement_details(WebDriver driver) throws AWTException {
		this.driver = driver;
	...
	public void opensportsachivements_details() {
		wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Sports Achievements"))).click();
		sleep(1000);
	}
	...
	{
		List<WebElement> Checkbox = driver.findElements(By.xpath("((//tbody[2]//input[@type='checkbox']))[position() mod 2=1]"));
	...
	public void addd() {
		...
		try {
			FileInputStream fis1 = new FileInputStream("D://KSP_Admin//Sports&gamesachivements.xlsx");// "D:\steno\TestDataAPC.xlsx"
			...
			for (int i = 1; i <= 10; i++) {
               ...
               clickonElement(save);
                ...
                {try {
    			    ...
    			    String[] errorIds = { "SportsAcheivement_Code-error", "SportsAcheivement_Title-error","SportsAcheivement_OrderIndex-error", "SportsAcheivement_StatusCode-error" };
                ...
                if(isElementClickable(driver, CancelEdit)) {
                	try {
                		try {
            			    ...
            			    // List of specific error IDs (extend this as needed)
            			    String[] errorIds = { "SportsAcheivementDTO_Code-error","SportsAcheivementDTO_Title-error" };
...
//                System.out.println(i+" iteration completed");
			...
			Changestatus(statusEdit);
             ...
             Thread.sleep(800);
            	...
            	sleep(800);
            	 fileOut = new FileOutputStream("D://KSP_Admin//Sports&gamesachivements.xlsx");
