...
public class Qualification_Board extends Utilies {
	...
	@FindBy(id = "QualificationBoard_Code")
	WebElement codeField;

	@FindBy(id = "QualificationBoard_Title")
	WebElement titleField;

	@FindBy(xpath = "//input[@id='QualificationBoard_IsEquivalent']/following-sibling::span[@class='slider-toggle']")
	WebElement isequivalenttoggle;

	@FindBy(id = "QualificationBoard_OrderIndexPUC")
	WebElement PUCorderIndexDropdown;

	@FindBy(xpath = "//select[@id='QualificationBoard_OrderIndexSSLC']")
	WebElement SSLCorderIndexDropdown;

	@FindBy(xpath = "//input[@id='QualificationBoard_IsApplicableForPUC']/following-sibling::span[@class='slider-toggle']")
	WebElement IsApplicableForPUCtoggle;

	@FindBy(xpath = "//input[@id='QualificationBoard_IsApplicableForSSLC']/following-sibling::span[@class='slider-toggle']")
	WebElement IsApplicableForSSLCtoggle;

	@FindBy(id = "QualificationBoard_StatusCode")
	...
	@FindBy(id = "QualificationBoardDTO_Code")
	WebElement Editcode;
	...
	@FindBy(xpath = "//input[@id='QualificationBoard_IsEquivalent']/following-sibling::span[@class='slider-toggle']")
	WebElement Editisequivalent;
	
	@FindBy(xpath = "//input[@id='QualificationBoardDTO_IsApplicableForSSLC']/following-sibling::span[@class='slider-toggle']")
	WebElement Editisapplicableforsslc;

	@FindBy(id="QualificationBoardDTO_OrderIndexSSLC")
	WebElement Editsslcorderindex;
	
	@FindBy(xpath="//input[@id='QualificationBoardDTO_IsApplicableForPUC']/following-sibling::span[@class='slider-toggle']")
	WebElement Editisapplicableforpuc;
	
	@FindBy(id = "QualificationBoardDTO_OrderIndexPUC")
	WebElement EditOrderindexpuc;
	
	@FindBy(id = "QualificationBoardDTO_StatusCode")
	...
	@FindBy(xpath = "//tbody[2]//tr[td//span[text()='1']]/td[8]//form")
	WebElement delete;
	...
	@FindBy(xpath="//button[@class='nav-link active' or text()='SSLC']")
	WebElement SSLCToggle;

	@FindBy(xpath="//button[@class='nav-link' and text()='PUC']")
	WebElement PUCToggle;
	...
	public Qualification_Board(WebDriver driver) throws AWTException {
		this.driver = driver;
	...
	public void openQualification_Board() {
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Qualification Board')]"))).click();
		sleep(1000);
	}
	...
	public void addd() {
		...
		try {
			FileInputStream fis1 = new FileInputStream("D://KSP_Admin//Identity_card.xlsx");// "D:\steno\TestDataAPC.xlsx"
			...
			for (int i = 1; i <= 10; i++) {
				...
				clickonElement(isequivalenttoggle);
				clickonElement(IsApplicableForPUCtoggle);
				clickonElement(IsApplicableForSSLCtoggle);
				...
				if (!isElementClickable(driver, entriesperpages)) {
					try {
						...
						String[] errorIds = { "IdentityCardType_Code-error", "IdentityCardType_Title-error","IdentityCardType_OrderIndex-error", "IdentityCardType_StatusCode-error" };
		...
		if (isElementClickable(driver, CancelEdit)) {
			try {
				try {
					boolean hasError = true;
					// List of specific error IDs (extend this as needed)
					String[] errorIds = { "IdentityCardTypeDTO_Code-error","IdentityCardTypeDTO_Title-error" };
				...
				fileOut = new FileOutputStream("D://KSP_Admin//Identity_card.xlsx");
