...
public class ksp_wings extends Utilies {
    ...
    @FindBy(id = "kSPWings_Code")
    WebElement codeField;

    @FindBy(id = "kSPWings_Title")
    WebElement titleField;

    @FindBy(id = "kSPWings_OrderIndex")
    WebElement orderIndexDropdown;

    @FindBy(xpath  = "//select[@id='KSPWings_StatusCode']")
    ...
    @FindBy(id="KSPWingsDTO_Code")
    WebElement Editcode;

    @FindBy(id="KSPWingsDTO_Title")
    WebElement Edittitle;

    @FindBy(id="KSPWingsDTO_OrderIndex")
    WebElement Editorderindex;

    @FindBy(id="KSPWingsDTO_StatusCode")
    ...
    public ksp_wings(WebDriver driver) throws AWTException {
        this.driver = driver;
    ...
    public void openKSPWings() {
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'KSP Wings')]"))).click();
        sleep(1000);
    }
    ...
    public void addd() {
        ...
        try
              {
            FileInputStream fis1 = new FileInputStream("D://KSP_Admin//ksp_wings.xlsx");//"D:\steno\TestDataAPC.xlsx"
            ...
            for (int i = 2; i <= 10; i++) {
               ...
               clickonElement(save);
                ...
                {try {
    			    ...
    			    String[] errorIds = {"kSPWings_Code-error", "kSPWings_Title-error", "kSPWings_OrderIndex-error", "kSPWings_StatusCode-error"
    			    };
                ...
                if(isElementClickable(driver, CancelEdit)) {
                	try {
                		try {
            			    ...
            			    // List of specific error IDs (extend this as needed)
            			    String[] errorIds = {"KSPWingsDTO_Code-error", "KSPWingsDTO_Title-error"
            			    };
...
//                System.out.println(i+" iteration completed");
             ...
             Thread.sleep(800);
            	...
            	sleep(800);
            	 fileOut = new FileOutputStream("D://KSP_Admin//ksp_wings.xlsx");
