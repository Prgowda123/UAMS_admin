...
public class Identity_card_type extends Utilies {
	...
	@FindBy(id = "IdentityCardType_Code")
	WebElement codeField;

	@FindBy(id = "IdentityCardType_Title")
	WebElement titleField;

	@FindBy(id = "IdentityCardType_OrderIndex")
	WebElement orderIndexDropdown;

	@FindBy(id = "IdentityCardType_StatusCode")
	...
	@FindBy(id = "IdentityCardTypeDTO_Code")
	WebElement Editcode;

	@FindBy(id = "IdentityCardTypeDTO_Title")
	WebElement Edittitle;

	@FindBy(id = "IdentityCardTypeDTO_OrderIndex")
	WebElement Editorderindex;

	@FindBy(id = "IdentityCardTypeDTO_StatusCode")
	...
	@FindBy(xpath = "//input[@type='checkbox' and @data-table='identitycardtypes']")
	...
	public Identity_card_type(WebDriver driver) throws AWTException {
		this.driver = driver;
	...
	public void openIdentity_card_type() {
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Identity Cards Types')]")))
				.click();
		sleep(1000);
	}
