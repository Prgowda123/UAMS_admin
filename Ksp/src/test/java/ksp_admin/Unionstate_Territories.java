...
public class Unionstate_Territories extends Utilies {
    ...
    @FindBy(id = "UnionStateTerritory_Code")
    WebElement codeField;

    @FindBy(id = "UnionStateTerritory_Title")
    WebElement titleField;

    @FindBy(id = "UnionStateTerritory_OrderIndex")
    WebElement orderIndexDropdown;

    @FindBy(id = "UnionStateTerritory_StatusCode")
    ...
    @FindBy(id="UnionStateTerritoryDTO_Code")
    WebElement Editcode;

    @FindBy(id="UnionStateTerritoryDTO_Title")
    WebElement Edittitle;

    @FindBy(xpath ="//select[@id='UnionStateTerritoryDTO_OrderIndex' and @ name='UnionStateTerritoryDTO.OrderIndex']")
    WebElement Editorderindex;

    @FindBy(xpath ="//select[@id='UnionStateTerritoryDTO_StatusCode' and @ name='UnionStateTerritoryDTO.StatusCode']")
    ...
    public Unionstate_Territories(WebDriver driver) throws AWTException {
        this.driver = driver;
    ...
    public void openUnionState_Territories() {
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Union State Territories')]"))).click();
        sleep(1000);
    }
    ...
    public void addd() {
        ...
        try
              {
            FileInputStream fis1 = new FileInputStream("D://KSP_Admin//union_state.xlsx");//"D:\steno\TestDataAPC.xlsx"
            ...
            for (int i = 1; i <= 20; i++) {
                ...
                {try {
    			    ...
    			    String[] errorIds = {"UnionStateTerritory_Code-error", "UnionStateTerritory_Title-error", "UnionStateTerritory_OrderIndex-error", "UnionStateTerritory_StatusCode-error"
    			    };
                ...
                String getViewTitle = getAttributeValue(By.name("UnionStateTerritory.Title"));
                String getOrderIndex = getAttributeValue(By.name("UnionStateTerritory.OrderIndex"));
                ...
                if(isElementClickable(driver, CancelEdit)) {
                	try {
                		try {
            			    ...
            			    // List of specific error IDs (extend this as needed)
            			    String[] errorIds = {"UnionStateTerritoryDTO_Code-error", "UnionStateTerritoryDTO_Title-error"
            			    };
...
//                System.out.println(i+" iteration completed");
             ...
             Thread.sleep(800);
            	...
            	sleep(800);
            	 fileOut = new FileOutputStream("D://KSP_Admin//union_state.xlsx");
