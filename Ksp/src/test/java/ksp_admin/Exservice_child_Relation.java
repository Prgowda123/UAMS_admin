...
public class Exservice_child_Relation extends Utilies {
    ...
    public  Exservice_child_Relation(WebDriver driver) throws AWTException {
        this.driver = driver;
    ...
    public void addd() {
        ...
        try
              {
            FileInputStream fis1 = new FileInputStream("D://KSP_Admin//Ex_service_child_Relation.xlsx");//"D:\steno\TestDataAPC.xlsx"
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                {try {
    			    ...
    			    String[] errorIds = {"ExServicemenRelation_Code-error", "ExServicemenRelation_Title-error", "ExServicemenRelation_OrderIndex-error", "ExServicemenRelation_StatusCode-error"
    			    };
                ...
                String getStatus = getAttributeValue(By.id("statusTitle"));
                ...
                if(isElementClickable(driver, CancelEdit)) {
                	try {
                		try {
            			    ...
            			    // List of specific error IDs (extend this as needed)
            			    String[] errorIds = {"ExServicemenRelationDTO_Code-error", "ExServicemenRelationDTO_Title-error"
            			    };
...
//                System.out.println(i+" iteration completed");
             ...
             sleep(1000);
            	 ...
            	 fileOut = new FileOutputStream("D://KSP_Admin//Ex_service_child_Relation.xlsx");
